...
impl HasRenderConfig for model::CgroupMemoryModel {
    fn get_render_config_builder(field_id: &Self::FieldId) -> RenderConfigBuilder {
        ...
        match field_id {
            ...
            EventsLow => rc.title("Events Low/s"),
            EventsHigh => rc.title("Events High/s"),
            EventsMax => rc.title("Events Max/s"),
            EventsOom => rc.title("Events OOM/s"),
            EventsOomKill => rc.title("Events Kill/s"),
            EventsSockThrottled => rc.title("Events Sock Throttled/s"),
            EventsLocalLow => rc.title("Events Local Low/s"),
            EventsLocalHigh => rc.title("Events Local High/s"),
            EventsLocalMax => rc.title("Events Local Max/s"),
            EventsLocalOom => rc.title("Events Local OOM/s"),
            EventsLocalOomKill => rc.title("Events Local Kill/s"),
            EventsLocalSockThrottled => rc.title("Events Local Sock Throttled/s"),
